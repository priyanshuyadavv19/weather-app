...
function SearchBar({ city, setCity, onSearch }) {
  ...
  return (
    <div className="flex gap-2 mb-4">
      <input className="flex-1 bg-gray-800 border border-gray-600 focus:outline-none shrink-0
      focus:ring-2 focus:ring-blue-500 rounded-lg px-3 md:px-4 py-2 text-white placeholder-gray-400"
